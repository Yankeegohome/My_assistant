...
__all__ = [
    'ISpeechPhraseProperties', 'DISPID_SMSSetData', 'ISpEventSink',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRPhraseInfo',
    'DISPID_SBSFormat', 'DISPID_SPELexicalForm',
    'DISPID_SOTGetDescription', 'SAFT32kHz16BitMono',
    'DISPID_SLWPronunciations', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPRuleChildren', 'SPBO_PAUSE',
    'SpeechStreamSeekPositionType', 'SP_VISEME_7',
    'SVEStartInputStream', 'SDTDisplayText', 'SpeechUserTraining',
    'SASRun', 'SGLexical', 'eLEXTYPE_USER_SHORTCUT',
    'SRSActiveAlways', 'ISpStream', 'SGDSActiveWithAutoPause',
    'STCInprocServer', 'DISPID_SPEPronunciation', 'ISpeechFileStream',
    'SREStateChange', 'SAFTCCITT_ALaw_11kHzMono', 'SPSHT_Unknown',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLWWord',
    'ISpeechRecoResult2', 'SVEBookmark', 'DISPID_SOTsItem',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRsCount',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPAPhraseInfo',
    'DISPID_SGRsItem', 'SP_VISEME_20', 'ISpNotifyTranslator',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTGSM610_44kHzMono',
    'DISPID_SRGCommit', 'DISPID_SPPConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPPROPERTYINFO',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SAVolume', 'SAFTADPCM_11kHzMono', 'DISPID_SRGetFormat',
    'SP_VISEME_21', 'DISPID_SVEViseme', 'SPRECOGNIZERSTATUS',
    'SAFT16kHz16BitStereo', 'SPADAPTATIONRELEVANCE',
    'DISPID_SPAsItem', 'DISPID_SVEVoiceChange',
    'DISPID_SPPEngineConfidence', 'SREStreamEnd',
    'DISPID_SPIElements', 'DISPID_SpeechRecoResult2',
    'eWORDTYPE_ADDED', 'SPSEMANTICFORMAT',
    ...
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRCEBookmark',
    'SpeechAudioFormatGUIDWave', 'SREAudioLevel', 'tagSPPROPERTYINFO',
    'SAFTExtendedAudioFormat', 'SAFTNoAssignedFormat',
    'SPEVENTSOURCEINFO', 'SRESoundStart', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTWeight', 'ISpeechLexiconWord',
    'DISPID_SpeechRecoResult', 'DISPID_SVSRunningState',
    'DISPID_SRGRecoContext', 'DISPID_SLPsItem',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPRuleNumberOfElements',
    'eLEXTYPE_PRIVATE10', 'SPINTERFERENCE_NONE', 'SBOPause',
    'DISPID_SPACommit', 'SAFT12kHz8BitMono', 'SPSHT_OTHER',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT32kHz8BitMono',
    'SPDKL_LocalMachine', 'DISPID_SASFreeBufferSpace', 'SPRS_ACTIVE',
    'DISPID_SPPId', 'SAFTCCITT_ALaw_11kHzStereo', 'SSTTTextBuffer',
    'DISPID_SVResume', 'DISPID_SRGetRecognizers',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_RESERVED10', 'DISPID_SOTDataKey',
    'SVP_3', 'DISPID_SpeechLexiconWords',
    'ISpeechGrammarRuleStateTransition', 'SPFM_CREATE_ALWAYS',
    'SRTExtendableParse', 'DISPID_SPRs_NewEnum', 'SPWORD',
    'STSF_LocalAppData', 'SPPS_RESERVED3', 'DISPID_SBSRead',
    'SPAR_Low', 'SpeechInterference', 'SINoSignal', 'SPSInterjection',
    'DISPID_SpeechPhraseProperty', 'SPAS_RUN',
    'DISPID_SpeechAudioFormat', 'SAFT48kHz8BitMono',
    'DISPID_SpeechMemoryStream', 'SPEI_RESERVED3', 'IEnumString',
    'DISPID_SpeechRecoContextEvents', 'SAFTADPCM_44kHzStereo',
    'STCRemoteServer', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVEStreamEnd', 'SAFT8kHz8BitMono',
    'DISPID_SABufferNotifySize', 'DISPID_SRState', 'SVEWordBoundary',
    'DISPID_SLRemovePronunciation', 'SPWAVEFORMATTYPE', 'SpShortcut',
    'SPFILEMODE', 'SVESentenceBoundary', 'SPEI_SOUND_END',
    'SPCATEGORYTYPE', 'SPAS_PAUSE', 'SVPAlert',
    ...
    'SpeechSpecialTransitionType', 'DISPID_SRGSetWordSequenceData',
    'ISpShortcut', 'DISPID_SRRTStreamTime', 'SpeechAudioProperties',
    'ISpeechResourceLoader', 'SPBO_NONE', 'ISpeechPhraseReplacements',
    'ISpRecoContext2', 'SPXMLRESULTOPTIONS',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRInitialState',
    'SRSEIsSpeaking', 'SAFT11kHz8BitMono', 'ISpeechWaveFormatEx',
    'SRCS_Enabled', 'ISpeechPhraseRules', 'SpFileStream',
    'Speech_StreamPos_RealTime', 'SpeechPropertyResponseSpeed',
    'DISPID_SABIEventBias', 'DISPID_SpeechVoice', 'SFTInput',
    'SPVPRIORITY', 'SpeechMicTraining', 'SPWF_INPUT',
    'SpeechTokenKeyUI', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpMMAudioEnum', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SWFEChannels', 'SP_VISEME_3', 'DISPID_SpeechGrammarRule',
    ...
    'ISpeechMMSysAudio', 'DISPID_SBSSeek', 'SGLexicalNoSpecialChars',
    'DISPID_SGRSTNextState', 'SAFT24kHz8BitMono',
    'ISpeechAudioStatus', 'DISPID_SRCEAudioLevel', 'SPSNotOverriden',
    'DISPID_SPRNumberOfElements', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTGetAttribute', 'DISPID_SAStatus', 'SGSDisabled',
    'SPSERIALIZEDPHRASE', 'ISpDataKey', 'DISPID_SOTIsUISupported',
    'SpeechRuleAttributes', 'SpeechRegistryLocalMachineRoot',
    'SpeechEngineProperties', 'SpeechCategoryAudioIn',
    'SpeechAudioState', 'SPCT_SUB_DICTATION', 'SPAS_CLOSED',
    'SpeechRetainedAudioOptions', 'SVSFlagsAsync', 'DISPID_SVVolume',
    'SpeechTokenContext', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechAudioBufferInfo', 'ISpeechRecoResult', 'SITooSlow',
    'DISPID_SGRName', 'DISPID_SRCERequestUI', 'ISpRecoResult',
    'ISpeechRecoGrammar', 'SPAS_STOP', 'DISPID_SpeechFileStream',
    'SPAUDIOBUFFERINFO', 'DISPID_SVSInputWordPosition',
    'SGRSTTDictation', 'DISPID_SWFEAvgBytesPerSec', 'SGRSTTWildcard',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPEsItem',
    'SVSFParseAutodetect', 'ISpeechVoice', 'SPEI_MAX_TTS',
    'SPWORDPRONUNCIATION', 'DISPID_SRCRetainedAudioFormat',
    'SAFT11kHz16BitMono', 'SpStreamFormatConverter',
    'DISPID_SRCCreateGrammar', 'SVF_None', 'SPSHT_EMAIL',
    'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechLexiconPronunciation', 'DISPID_SAFGuid',
    '_RemotableHandle', 'SRAONone', 'ISpPhoneticAlphabetSelection',
    'ISpeechLexiconWords', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPEDisplayAttributes', 'DISPID_SpeechPhraseElement',
    'DISPID_SRRSpeakAudio', 'DISPID_SOTDisplayUI', 'ISpProperties',
    'SREInterference', 'SAFT48kHz16BitMono', 'SPCONTEXTSTATE',
    'DISPID_SRCRequestedUIType', 'DISPID_SVEPhoneme',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SGRsDynamic',
    'SPDKL_DefaultLocation', 'DISPID_SpeechAudio', 'SRARoot',
    'SAFT16kHz8BitMono', 'DISPID_SWFEExtraData',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SVPriority',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechPhraseBuilder',
    'ISpGrammarBuilder', 'SPEVENTENUM', 'SITooLoud', 'SpLexicon',
    'SVP_15', 'SRAORetainAudio', 'SAFTADPCM_11kHzStereo',
    'SDTPronunciation', 'DISPID_SPRsCount', 'SVSFIsFilename',
    'DISPID_SVDisplayUI', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechPhraseElements', 'SpeechDictationTopicSpelling',
    'ISpStreamFormat', 'DISPID_SPRulesCount', 'SRSEDone',
    'DISPID_SGRsCommit', 'SRTAutopause',
    'DISPID_SpeechPhraseReplacements', 'ISpeechGrammarRuleState',
    'ISpeechRecognizer', 'DISPID_SPIEngineId',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTPropertyId',
    'DISPID_SDKGetlongValue', 'SAFT22kHz8BitMono', 'DISPID_SFSClose',
    'SP_VISEME_8', 'SpeechDisplayAttributes', 'SPAO_RETAIN_AUDIO',
    'SPBINARYGRAMMAR', 'SRCS_Disabled', 'eLEXTYPE_PRIVATE19',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SLTUser', 'DISPIDSPRG',
    'DISPID_SPIEnginePrivateData', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT22kHz8BitStereo', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SLWLangId', 'SRERequestUI', 'STSF_FlagCreate',
    'DISPID_SGRSAddSpecialTransition', 'eLEXTYPE_VENDORLEXICON',
    'SAFTDefault', 'DISPID_SPRuleFirstElement', 'DISPID_SRIsShared',
    'DISPID_SPCPhoneToId', 'SRADefaultToActive', 'SPWT_LEXICAL',
    'SPGS_ENABLED', 'SP_VISEME_12', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_RESERVED6', 'SVPNormal', 'SECLowConfidence', 'SP_VISEME_6',
    'SVP_21', 'ISpeechRecoResultTimes', 'ISpEventSource',
    'SAFTADPCM_22kHzMono', 'SPRECORESULTTIMES', 'SASPause',
    'DISPID_SVGetAudioInputs', 'eLEXTYPE_PRIVATE14',
    'Speech_Max_Word_Length', 'DISPID_SVVoice', 'SpeechAllElements',
    'ISpeechGrammarRule', 'SRSActive',
    'DISPID_SPERetainedStreamOffset', 'SPAR_Unknown',
    'SpeechWordType', 'eLEXTYPE_PRIVATE2', 'SASClosed',
    'ISpPhoneConverter', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_LETTERTOSOUND',
    'SSTTWildcard', '_ISpeechVoiceEvents',
    'DISPID_SRRSetTextFeedback', 'ISpeechMemoryStream',
    'DISPID_SRSCurrentStreamNumber', 'ISpeechLexicon',
    'DISPID_SpeechRecoResultTimes', 'SAFT22kHz16BitStereo',
    'SpUnCompressedLexicon', 'SpTextSelectionInformation',
    'SPEI_REQUEST_UI', 'SpeechGrammarTagUnlimitedDictation', 'STCAll',
    'DISPID_SLPLangId', 'SPPHRASEREPLACEMENT', 'DISPID_SRCBookmark',
    'SpeechRecoEvents', 'DISPID_SRSetPropertyString',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRGDictationSetState',
    'DISPID_SVRate', 'DISPID_SpeechVoiceEvent', 'DISPID_SOTCDefault',
    'SREStreamStart', 'DISPID_SVEWord', 'SpCompressedLexicon',
    'DISPID_SVEBookmark', 'SVP_11', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SAFType',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpeechPhraseInfo', 'eLEXTYPE_APP', 'SREPhraseStart',
    '__MIDL_IWinTypes_0009', 'SAFT24kHz16BitMono', 'SVP_14',
    'DISPID_SVAudioOutput', 'DISPID_SPIStartTime', 'SpMMAudioOut',
    'SPXRO_Alternates_SML', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SDKGetBinaryValue', 'SAFT44kHz16BitStereo',
    'DISPID_SRCEHypothesis', 'SpeechRuleState',
    'DISPID_SASCurrentDevicePosition', 'SREPropertyNumChange',
    'DISPID_SGRSTRule', 'SAFTGSM610_8kHzMono',
    'SAFTCCITT_ALaw_8kHzMono', 'ISpeechPhraseElement',
    'DISPID_SLPPhoneIds', 'SpeechTokenShellFolder',
    'DISPID_SRCERecognitionForOtherContext', 'SPRST_ACTIVE',
    'DISPID_SVESentenceBoundary', 'DISPID_SPEEngineConfidence',
    'DISPID_SPIReplacements', 'DISPID_SPIRetainedSizeBytes',
    'SPWT_PRONUNCIATION', 'ISpeechAudio', 'DISPID_SRGId',
    'SVSFNLPMask', 'ISpRecognizer2', 'SPPS_Noun',
    'ISpeechAudioBufferInfo', 'DISPID_SPIAudioStreamPosition',
    'SVSFPersistXML', 'SpeechCategoryRecognizers',
    'DISPID_SPEs_NewEnum', 'SpeechPropertyHighConfidenceThreshold',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_INTERFERENCE',
    'SpeechVoiceEvents', 'SpeechVoiceSpeakFlags', 'ISpVoice',
    'SpSharedRecognizer', 'SPSHT_NotOverriden', 'SVSFIsNotXML',
    'ISpRecoGrammar', 'IEnumSpObjectTokens',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPEI_MAX_SR',
    'SPINTERFERENCE_NOISE', 'SPSFunction', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFT24kHz16BitStereo', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPPChildren', 'SP_VISEME_13', 'ISpeechRecoResultDispatch',
    'DISPID_SRRTTickCount', 'DISPID_SPPParent', 'DISPID_SPRuleName',
    'DISPID_SMSALineId', 'DISPID_SGRsAdd', 'DISPID_SVIsUISupported',
    'DISPID_SDKEnumKeys', 'ISequentialStream', 'DISPID_SPIRule',
    'SAFT48kHz8BitStereo', 'DISPID_SOTCreateInstance',
    'SAFTCCITT_uLaw_8kHzStereo', 'STCInprocHandler',
    ...
    'eLEXTYPE_RESERVED8', 'DISPID_SOTCategory',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIAudioSizeTime',
    'SPPS_Unknown', 'SPEI_START_SR_STREAM', 'SPEI_SR_BOOKMARK',
    'DISPID_SRCEStartStream', 'DISPID_SPARecoResult',
    'SpeechCategoryRecoProfiles', 'DISPID_SRSetPropertyNumber',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPRuleId', 'ISpeechLexiconPronunciations',
    'SPCT_DICTATION', 'DISPID_SGRsCommitAndSave', 'SPFM_NUM_MODES',
    'DISPID_SpeechPhoneConverter', 'SVP_5', 'DISPID_SGRId',
    'SECFIgnoreWidth', 'SVP_7', 'ISpeechPhraseInfoBuilder',
    'eLEXTYPE_PRIVATE16', 'SpeechGrammarTagWildcard',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SpeechPhraseElements',
    'ISpRecognizer', 'SAFT16kHz16BitMono', 'SDTAlternates',
    'SECFIgnoreCase', 'SWTAdded', 'DISPID_SRCEPhraseStart', 'SASStop',
    'SpeechPropertyNormalConfidenceThreshold', 'SPSTREAMFORMATTYPE',
    'SGDisplay', 'SVEViseme', 'SPINTERFERENCE_TOOSLOW', 'SDTAll',
    'SPPS_RESERVED4', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRCERecognition', 'SPEI_VOICE_CHANGE',
    'SWPKnownWordPronounceable', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpObjectToken', 'SpeechDiscardType', 'DISPID_SpeechPhraseInfo',
    'SpeechCategoryVoices',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SRCEInterference', 'SPVPRI_ALERT',
    'SpeechGrammarWordType', 'SP_VISEME_10', 'SREPrivate',
    'DISPID_SpeechXMLRecoResult', 'STSF_AppData', 'eLEXTYPE_PRIVATE3',
    'eLEXTYPE_PRIVATE17', 'SVP_1', 'eLEXTYPE_MORPHOLOGY',
    'SAFT12kHz16BitMono', 'SPEI_RECOGNITION', 'SpCustomStream',
    'DISPID_SPEsCount', 'SpWaveFormatEx', 'DISPID_SRGIsPronounceable',
    'DISPID_SOTs_NewEnum', 'DISPID_SLGetPronunciations',
    'DISPID_SASState', 'SPXRO_SML', 'DISPID_SABIMinNotification',
    'SPPS_NotOverriden', 'SVP_12', 'SpeechRecognizerState',
    'DISPID_SDKSetBinaryValue', 'SDKLCurrentConfig',
    'SPCT_SUB_COMMAND', 'SpeechRecoProfileProperties',
    'ISpNotifySink', 'SVEPhoneme', 'SpVoice', 'DISPID_SRGRules',
    'SLTApp', 'SAFT8kHz8BitStereo', 'SAFT12kHz16BitStereo',
    'SPRULESTATE', 'SRERecoOtherContext', 'SREBookmark',
    'DISPID_SRRTLength', 'SGRSTTEpsilon', 'SPSVerb',
    'DISPID_SpeechPhraseAlternates', 'SPRULE', 'SRESoundEnd',
    'SpPhoneConverter', 'DISPID_SDKEnumValues', 'SpeechFormatType',
    'SAFT8kHz16BitStereo', 'DISPID_SRCEEndStream',
    'SpeechPartOfSpeech', 'ISpObjectTokenCategory',
    'SpNotifyTranslator', 'DISPID_SOTId', 'SpResourceManager',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE15', 'SPSHORTCUTPAIR',
    'DISPID_SGRsFindRule', 'SRSInactiveWithPurge',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPVPRI_NORMAL',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGCmdSetRuleIdState', 'SREHypothesis',
    'DISPID_SVSPhonemeId', 'eLEXTYPE_PRIVATE18', 'SPEI_END_SR_STREAM',
    'SDKLCurrentUser', 'DISPID_SpeechPhraseProperties',
    'DISPID_SLPType', 'SPEI_PHONEME', 'ISpeechVoiceStatus',
    'DISPID_SASetState', 'DISPID_SPRFirstElement', 'SSFMOpenForRead',
    'SpeechLexiconType', 'SPEI_HYPOTHESIS', 'DISPID_SPPName',
    'DISPID_SPRuleConfidence', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SVWaitUntilDone', 'Speech_Max_Pron_Length',
    'DISPID_SRGDictationUnload', 'SPSHORTCUTPAIRLIST',
    'DISPID_SRSAudioStatus', 'DISPID_SPISaveToMemory',
    'DISPID_SRIsUISupported', 'DISPID_SPRDisplayAttributes',
    'DISPID_SRRecognizer', 'SpeechAudioFormatType',
    'DISPID_SVEventInterests', 'DISPID_SRGetPropertyNumber',
    'SPEI_RESERVED5', 'SRTReSent',
    'SpeechPropertyComplexResponseSpeed', 'SVP_9', 'SpMMAudioIn',
    'SAFTADPCM_44kHzMono', 'SPRST_NUM_STATES', 'ISpeechBaseStream',
    'SVSFVoiceMask', 'DISPID_SpeechObjectToken', 'SRAImport',
    'DISPID_SRGState', 'SPLOADOPTIONS', 'SPEI_TTS_BOOKMARK', 'SVP_2',
    'DISPID_SRCESoundStart', 'SPGS_DISABLED', 'SGSExclusive',
    'DISPID_SOTCGetDataKey', 'DISPIDSPTSI', 'SpeechCategoryAudioOut',
    'DISPID_SVSpeak', 'DISPID_SRCERecognizerStateChange',
    'SPWORDTYPE', 'DISPID_SRRAlternates', 'ISpRecoContext',
    'SAFT44kHz8BitStereo', 'SDTProperty', 'DISPID_SABIBufferSize',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPRST_INACTIVE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechObjectTokenCategory', 'SPDATAKEYLOCATION',
    'SpeechTokenValueCLSID', 'SpInprocRecognizer',
    'DISPID_SGRSTransitions', 'SpeechGrammarState', 'SP_VISEME_9',
    'SAFTText', 'DISPIDSPTSI_ActiveOffset', 'SVEVoiceChange',
    'DISPID_SRCRecognizer', 'SINone', 'ISpRecoGrammar2',
    'SPEI_TTS_PRIVATE', 'SRTSMLTimeout', 'SPEI_ADAPTATION',
    'SPAUDIOSTATE', 'SAFTCCITT_uLaw_44kHzMono',
    'SPEI_SR_RETAINEDAUDIO', 'STCLocalServer', 'ISpeechObjectTokens',
    'DISPID_SPRulesItem', 'SPCS_DISABLED',
    'DISPID_SLAddPronunciation', 'SPBO_AHEAD',
    'DISPID_SpeechRecognizerStatus', 'SPPS_Noncontent',
    'SGRSTTTextBuffer', 'SPFM_OPEN_READWRITE', 'SPCT_SLEEP',
    'SGPronounciation', 'SVP_10', 'SAFTGSM610_11kHzMono',
    'ISpMMSysAudio', 'SPLEXICONTYPE', 'DISPID_SOTsCount',
    'DISPID_SPPsCount', 'eLEXTYPE_PRIVATE13', 'SPRECOSTATE',
    'DISPID_SOTMatchesAttributes', 'SPEI_PROPERTY_STRING_CHANGE',
    'SVSFParseSsml', 'SREAllEvents', 'DISPID_SVSInputSentenceLength',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRAudioInputStream',
    'DISPID_SVSLastBookmark', 'DISPID_SPPs_NewEnum', 'SVSFParseSapi',
    'DISPID_SRGSetTextSelection', 'SPINTERFERENCE_NOSIGNAL',
    'eWORDTYPE_DELETED', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRCVoice', 'DISPID_SLGetGenerationChange', 'SPCS_ENABLED',
    'ISpeechPhraseProperty', 'DISPID_SOTRemoveStorageFileName',
    'SpNullPhoneConverter', 'DISPID_SGRs_NewEnum',
    'DISPID_SPIGrammarId', 'SDTAudio', 'SPSMF_UPS',
    'SpeechLoadOption', 'SPPHRASE', 'SGDSActiveUserDelimited',
    'DISPID_SOTCEnumerateTokens', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SVPause', 'DISPID_SRCEEnginePrivate', 'DISPID_SPAsCount',
    '_ISpeechRecoContextEvents', 'SSSPTRelativeToStart',
    'SAFT16kHz8BitStereo', 'SPINTERFERENCE',
    'DISPID_SPIGetDisplayAttributes', 'SVP_19', 'SVPOver',
    'SGRSTTWord', 'eLEXTYPE_PRIVATE8', 'DISPID_SRRSaveToMemory',
    'DISPID_SRCState', 'SRAInterpreter',
    'DISPID_SRSNumberOfActiveRules', 'SVSFIsXML', 'SPFM_CREATE',
    'ISpeechObjectToken', 'ISpeechPhraseReplacement',
    'SpeechVoicePriority', 'DISPID_SASNonBlockingIO',
    'SpPhraseInfoBuilder', 'SpeechRunState',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPRsItem',
    'DISPID_SGRSTPropertyName', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_PRIVATE5', 'DISPID_SOTCSetId', 'DISPID_SABufferInfo',
    'ISpeechTextSelectionInformation', 'SpPhoneticAlphabetConverter',
    'SPEI_WORD_BOUNDARY', 'ISpeechRecoContext', 'DISPID_SLWType',
    'SVP_0', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SpeechRecognizer', 'DISPID_SpeechPhraseAlternate',
    'SRTStandard', 'ISpeechPhoneConverter', 'SpeechDataKeyLocation',
    'SVP_8', 'SFTSREngine', 'SDA_Consume_Leading_Spaces',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPILanguageId',
    'SpeechEngineConfidence', 'DISPID_SRGetPropertyString',
    'eLEXTYPE_PRIVATE11', 'LONG_PTR', 'SpeechVisemeFeature',
    'SPVPRI_OVER', 'DISPID_SDKSetStringValue', 'DISPID_SPPValue',
    'SPAUDIOSTATUS', 'SPPS_LMA', 'SPPS_RESERVED1',
    'DISPID_SDKSetLongValue', 'SpeechCategoryAppLexicons',
    'SpSharedRecoContext', 'SWTDeleted', 'DISPID_SGRSTsItem',
    'DISPID_SDKCreateKey', 'SVEPrivate', 'DISPID_SpeechPhraseRule',
    'DISPID_SGRAddResource', 'SPSMF_SAPI_PROPERTIES', 'SGDSActive',
    'DISPID_SMSADeviceId', 'SPPS_Verb', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFTADPCM_22kHzStereo', 'DISPID_SLWs_NewEnum',
    'SAFTCCITT_uLaw_11kHzMono', 'SREFalseRecognition',
    'SPWF_SRENGINE', 'SPEI_SOUND_START', 'DISPID_SOTSetId',
    'SSFMOpenReadWrite', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SDKLLocalMachine', 'DISPID_SOTCId', 'SPSEMANTICERRORINFO',
    'SPPS_SuppressWord', 'DISPID_SFSOpen', 'SGSEnabled',
    'DISPID_SPAStartElementInResult', 'DISPID_SLWsCount', 'SVP_17',
    'ISpeechGrammarRules', 'eLEXTYPE_RESERVED4', 'SVSFUnusedFlags',
    'SPLO_STATIC', 'SP_VISEME_5', 'SVF_Stressed',
    'DISPID_SpeechLexicon', 'DISPID_SpeechGrammarRules',
    'DISPID_SASCurrentSeekPosition', 'ISpPhraseAlt',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGCmdSetRuleState',
    'SpeechTokenKeyFiles', 'SPEI_RESERVED1',
    'DISPID_SRRDiscardResultInfo', 'Speech_StreamPos_Asap',
    'SRSInactive', 'SpAudioFormat', 'DISPID_SMSAMMHandle',
    'SLOStatic', 'SpeechTokenIdUserLexicon', 'ISpeechAudioFormat',
    'SPPS_Function', 'SECFDefault', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechBaseStream', 'SpeechAudioVolume',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SMSGetData',
    'SPVISEMES', 'SPEI_PHRASE_START', 'IInternetSecurityManager',
    'DISPID_SRRAudio', 'SDTLexicalForm', 'DISPID_SLPSymbolic',
    'SPSNoun', 'SECHighConfidence', 'SP_VISEME_15', 'SVP_6',
    'SAFT32kHz16BitStereo', 'SPVOICESTATUS',
    'DISPID_SRCEventInterests', 'DISPID_SVGetProfiles',
    'SP_VISEME_11', 'eLEXTYPE_PRIVATE1', 'DISPID_SGRSTType',
    ...
    'DISPID_SLGetWords', 'DISPID_SVSpeakStream', 'SECFNoSpecialChars',
    'DISPID_SRCEPropertyStringChange', 'SWPUnknownWordPronounceable',
    'SpeechBookmarkOptions', 'SPPHRASEPROPERTY', 'SPAUDIOOPTIONS',
    'SREAdaptation', 'SPEI_START_INPUT_STREAM', 'SVF_Emphasis',
    'SPBOOKMARKOPTIONS', 'SPPS_Interjection', 'SPFM_OPEN_READONLY',
    'DISPID_SRSClsidEngine', 'SITooFast', 'SDTReplacement',
    'SPCT_COMMAND', 'SpeechPropertyResourceUsage',
    'SAFT44kHz8BitMono', 'DISPID_SVEStreamStart',
    'DISPID_SPRules_NewEnum', 'SSFMCreateForWrite',
    'SPDKL_CurrentConfig', 'eLEXTYPE_RESERVED9', 'SPSSuppressWord',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SAFTCCITT_uLaw_8kHzMono', 'SpeechTokenKeyAttributes',
    'DISPID_SpeechLexiconWord', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SGRSTsCount', 'IStream', 'DISPID_SRRTimes',
    'DISPID_SLWsItem', 'SPAO_NONE', 'tagSTATSTG', 'WAVEFORMATEX',
    'DISPID_SOTRemove', 'Speech_Default_Weight',
    'SAFT12kHz8BitStereo', 'SPEI_VISEME', 'SPEI_RECO_OTHER_CONTEXT',
    'STSF_CommonAppData', 'DISPID_SpeechCustomStream',
    'DISPID_SRRAudioFormat', 'SpeechRegistryUserRoot',
    'DISPID_SRCCmdMaxAlternates', 'SSSPTRelativeToEnd',
    'ISpStreamFormatConverter', 'ISpeechCustomStream', 'SRADynamic',
    'SAFT22kHz16BitMono', 'SSFMCreate', 'SREPropertyStringChange',
    'DISPID_SpeechAudioStatus', 'ISpRecognizer3', 'DISPID_SVSkip',
    'DISPID_SLPPartOfSpeech', 'eLEXTYPE_RESERVED7', 'SRAExport',
    'SpInProcRecoContext', 'ISpeechPhraseRule', 'SVEEndInputStream',
    'SAFT11kHz16BitStereo', 'SpeechWordPronounceable',
    'SECNormalConfidence', 'SECFIgnoreKanaType', 'SVEAudioLevel',
    'SAFTCCITT_ALaw_44kHzMono', 'SPSUnknown', 'SVEAllEvents',
    'DISPID_SPEDisplayText', 'DISPID_SRCSetAdaptationData',
    'SVSFDefault', 'SPPARTOFSPEECH', 'SP_VISEME_1',
    'DISPID_SRCEFalseRecognition',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SVStatus',
    'SPWORDLIST', 'eLEXTYPE_PRIVATE20', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFTGSM610_22kHzMono', 'SpeechCategoryPhoneConverters',
    'SPEI_END_INPUT_STREAM', 'ISpPhrase', 'SP_VISEME_0',
    '_SPAUDIOSTATE', 'DISPID_SPIProperties', 'SP_VISEME_18',
    'SPPHRASERULE', 'SPPS_RESERVED2', 'DISPID_SRRRecoContext',
    'DISPID_SGRSRule', 'DISPID_SVSInputWordLength', 'SPLO_DYNAMIC',
    'DISPIDSPTSI_SelectionOffset', 'SpeechAudioFormatGUIDText',
    'DISPID_SDKOpenKey', 'SPSLMA', 'SpeechVoiceCategoryTTSRate',
    'SAFT48kHz16BitStereo', 'SpObjectTokenCategory', 'SPEI_RESERVED2',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_MIN_SR', 'SVP_18',
    'SITooQuiet', 'DISPIDSPTSI_SelectionLength', 'ISpeechDataKey',
    'SPPS_Modifier', 'ISpNotifySource', 'ISpLexicon',
    'SDA_Two_Trailing_Spaces', 'SpeechRecoContextState',
    'SRATopLevel', 'SRTEmulated', 'ISpPhoneticAlphabetConverter',
    'SpObjectToken', 'DISPID_SPCIdToPhone',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SREmulateRecognition',
    'SVP_4', 'SSTTDictation', 'SECFEmulateResult',
    'DISPID_SRDisplayUI', 'DISPID_SLPsCount', 'ISpAudio',
    'SPWT_DISPLAY', 'tagSPTEXTSELECTIONINFO',
    'IInternetSecurityMgrSite', 'DISPID_SRRTOffsetFromStart',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechObjectTokens',
    'ISpeechPhraseAlternates', 'SVP_20', 'SRERecognition',
    'SpeechGrammarTagDictation', 'DISPID_SpeechPhraseRules',
    'SPGRAMMARWORDTYPE', 'SP_VISEME_14', 'SPEVENT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVGetVoices',
    'DISPID_SPRuleParent', 'DISPID_SRGCmdLoadFromObject',
    'SAFTCCITT_uLaw_44kHzStereo', 'SP_VISEME_4', 'DISPID_SRProfile',
    'SPSERIALIZEDRESULT', 'ISpSerializeState', 'SLODynamic',
    'DISPID_SDKDeleteValue', 'SPGRAMMARSTATE', 'SVSFParseMask',
    'eLEXTYPE_USER', 'DISPID_SPEAudioSizeBytes', 'SP_VISEME_19',
    'DISPID_SGRClear', 'DISPID_SPCLangId', 'SDA_One_Trailing_Space',
    'DISPID_SVSLastBookmarkId', 'DISPID_SGRAddState',
    'SpeechPropertyAdaptationOn', 'DISPID_SBSWrite',
    'SPPHRASEELEMENT', 'eLEXTYPE_PRIVATE7',
    'DISPID_SpeechLexiconProns', 'DISPID_SADefaultFormat',
    'DISPID_SPIGetText', 'SAFT8kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SWFEBitsPerSample', 'SP_VISEME_17', 'SPSHORTCUTTYPE',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechMMSysAudio',
    'SPRECOCONTEXTSTATUS', 'ISpeechPhraseAlternate',
    'DISPID_SLGenerationId', 'DISPID_SVSLastResult',
    'DISPID_SRCreateRecoContext', 'SPBO_TIME_UNITS',
    'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE4', 'SBONone',
    'SPWORDPRONOUNCEABLE', 'SPSModifier', 'DISPID_SDKDeleteKey',
    'DISPID_SGRSTs_NewEnum', 'SAFTNonStandardFormat',
    'SpMemoryStream', 'SVP_13', 'SP_VISEME_16', 'DISPID_SRGReset',
    'SPGS_EXCLUSIVE', 'DISPID_SGRAttributes', 'SpeechAddRemoveWord',
    'DISPID_SRCESoundEnd', 'ISpResourceManager',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechGrammarRuleState', 'SGRSTTRule',
    'DISPID_SRRGetXMLResult', 'DISPID_SPERetainedSizeBytes',
    'SVSFNLPSpeakPunc', 'DISPID_SVEEnginePrivate',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPAR_Medium', 'DISPID_SRCResume',
    'DISPID_SPPsItem', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRAudioInput',
    'SDTRule', 'DISPID_SPRText', 'UINT_PTR', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEActualConfidence', 'SPEI_MIN_TTS', 'SINoise',
    'SVSFPurgeBeforeSpeak', 'SpStream', 'SP_VISEME_2',
    'ISpXMLRecoResult', 'DISPID_SpeechDataKey',
    'DISPID_SAEventHandle', 'DISPID_SPEAudioStreamOffset',
    'SpeechStreamFileMode', 'DISPID_SAFGetWaveFormatEx',
    'SAFT44kHz16BitMono', 'SPEI_SR_PRIVATE', 'SPAR_High',
    'SAFT11kHz8BitStereo', 'DISPID_SWFEFormatTag', 'SVP_16',
    'SGDSInactive', 'DISPID_SDKGetStringValue', 'SPRS_INACTIVE',
    'DISPID_SRCPause', 'SPTEXTSELECTIONINFO',
    'ISpeechObjectTokenCategory'
]

_check_version('1.1.13', 1633527071.148833)
